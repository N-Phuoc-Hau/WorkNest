...
namespace BEWorkNest.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowerId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RecruiterId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Follows_AspNetUsers_RecruiterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Follows_FollowerId_RecruiterId",
                table: "Follows",
                columns: new[] { "FollowerId", "RecruiterId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Follows_RecruiterId",
                table: "Follows",
                column: "RecruiterId");
