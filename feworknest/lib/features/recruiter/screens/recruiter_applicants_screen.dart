...
class _RecruiterApplicantsScreenState extends ConsumerState<RecruiterApplicantsScreen> {
  ...
  Future<void> _startChatWithApplicant(ApplicationModel applicant) async {
    ...
    try {
      ...
      print('DEBUG: Using room ID: $roomId');
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ChatDetailScreen(
            roomId: roomId,
            otherUserName: applicant.applicantName,
            otherUserAvatar: applicant.applicant?.avatar ?? '',
            jobInfo: jobInfo,
          ),
        ),
      );
      ...
      NotificationHelper.showSuccess(
        context,
        'Bắt đầu cuộc trò chuyện với ${applicant.applicantName}',
      );
