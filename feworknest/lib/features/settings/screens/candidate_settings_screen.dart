...
class CandidateSettingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CandidateSettingsScreen> createState() => _CandidateSettingsScreenState();
}

class _CandidateSettingsScreenState extends ConsumerState<CandidateSettingsScreen> {
      ...
      body: ListView(
        children: [
          ...
          _buildListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Chuyển đến trang chỉnh sửa hồ sơ')),
              );
            },
          ),
          _buildListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Tính năng thay đổi ảnh đại diện đang phát triển')),
              );
            },
          ),
          ...
          SwitchListTile(
            ...
            title: const Text('Cảnh báo việc làm'),
            subtitle: const Text('Thông báo việc làm phù hợp'),
            value: _jobAlerts,
            onChanged: (value) {
              setState(() {
                _jobAlerts = value;
          ...
          _buildListTile(
            ...
            subtitle: 'Quản lý quyền riêng tư hồ sơ',
            onTap: () {
